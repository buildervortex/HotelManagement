            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (hotel.phoneNumbers.isNotEmpty)
                    Text("Phone: ${hotel.phoneNumbers.first.number}"),
                ],
              ),
            ),
          );
...
class Hotel {
  ...
  String get mobile => "N/A";
  String get facilities => "N/A";
  double get price => 10000.0; // default price
  String get description => "No description available.";
  String get category => "General";
  String get priceType => "Per Night";
}
