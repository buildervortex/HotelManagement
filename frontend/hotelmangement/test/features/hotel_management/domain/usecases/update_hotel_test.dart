...
void main() {
  ...
  group("hotel Tests", () {
    test("should update the hotel details and return the updated hotel entity",
      ...
      when(repository.updateHotel(
              params.hotelId, null, "new address", null, params.latitude, null))
      ...
      verify(repository.updateHotel(params.hotelId, any, any, any, any, any))
          .called(1);
    ...
    test(
      ...
      verifyNever(
          repository.updateHotel(params.hotelId, any, any, any, any, any));
      verify(repository.getHotel(params.hotelId)).called(1);
      verifyNoMoreInteractions(repository);
    });
  });
