...
// in hotelmangement/test/features/hotel_management/domain/usecases/hotel/get_hotel_image_auth_url_test.dart.
...
class MockFileRepository extends _i1.Mock implements _i3.FileRepository {
  ...
  @override
  _i4.Future<_i2.Either<_i5.Failure, String>> getFileAuthUrl(
    String? filePath,
    String? bucketName,
  ) =>
      (super.noSuchMethod(
            Invocation.method(#getFileAuthUrl, [filePath, bucketName]),
